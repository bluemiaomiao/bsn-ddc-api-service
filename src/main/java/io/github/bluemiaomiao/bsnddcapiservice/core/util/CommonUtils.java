...
public class CommonUtils {
    ...
    public static String parseByte2HexStr(byte[] buf) {
        logger.info("parseByte2HexStr start...");
        ...
        logger.info("parseByte2HexStr end...");
        return sb.toString();
    }
    ...
    public static String readFile(String filePath) throws IOException {
        logger.info("readFile dir:{}", filePath);
    ...
    public static List<String> readFileToList(String filePath) throws IOException {
        logger.debug("readFile dir:{}", filePath);
        File dirFile = new File(filePath);
        if (!dirFile.exists()) {
            return null;
        }
    ...
    public static String getCurrentIp() {
        try {
            ...
            logger.error("getCurrentIp error.");
        }
        return null;
    }
    ...
    public static String fileToBase64(String filePath) {
        ...
        try {
            ...
            logger.error("base64ToFile IOException:[{}]", e.toString());
        } finally {
            close(inputFile);
        }
        return null;
    ...
    public static String fileToZipBase64(List<File> srcFiles) {
        ...
        try {
            ...
            for (File srcFile : srcFiles) {
                ...
                logger.info("fileToZipBase64 fileName: [{}] size: [{}] ", srcFile.getName(),
                        srcFile.length());
            ...
            logger.info("fileToZipBase64 cost time：[{}] ms", (end - start));
        } catch (IOException e) {
            logger.error("fileToZipBase64 IOException:[{}]", e.toString());
        } finally {
            close(zos);
        }
        ...
        try {
            ...
            while (entry != null) {
                if (entry.isDirectory()) {
                    ...
                    logger.info("zipBase64ToFile file name:[{}]", entry.getName());
    ...
    private static void close(Closeable closeable) {
        if (closeable != null) {
            try {
                ...
                logger.error("closeable IOException:[{}]", e.toString());
            }
        }
    }
    /**
